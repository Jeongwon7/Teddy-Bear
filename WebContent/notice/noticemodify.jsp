		...
		<div class="container">
			<div class="row">
				...
				<div class="col-md-9 newitem">
				  <h2>공지사항 수정</h2>
					 <form class="form-horizontal" name="notice" method="post" action="noticemodifypro.do" onsubmit="return check();" enctype="multipart/form-data">
				  ...
				  <!-- action을 처리하기전에 check()사용자 함수를 실행하고 되돌아 와라-->
						<table class="table">
							...
							<tbody>
								<tr>
									<th>글쓴이</th>
									<td><input type="text" name="writer" style="width:100%;" value="${dto.writer}"></td>
								</tr>
								<tr>
									<th>제목</th>
									<td><input type="text" name="title" style="width:100%;" value="${dto.title}"></td>
								</tr>
								<tr>
									<th>내용</th>
