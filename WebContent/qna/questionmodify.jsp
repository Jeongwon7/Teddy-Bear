			...
			<div class="row">
				...
				<div class="col-md-9 newitem">
				  <h2>Question Modify</h2>
					<form class="form-horizontal" name="qfrm" method="post" enctype="multipart/form-data">
					<input type="hidden" name="qbno" value="${qvo.qbno}">
					<input type="hidden" name="pseq" value="${qvo.pseq}">
					 <div class="form-group">
					    <label for="title" class="col-sm-2 control-label">제목</label>
					    <div class="col-sm-10">
					      <input type="text" name="title" class="form-control" id="title" value="${qvo.title}">
					    </div>
					  </div>
					  <div class="form-group">
					   ...
					   <div class="form-group">
					    ...
					    <div class="col-sm-10">
					      <textarea name="content" id="summernote" class="form-control" rows="10">${qvo.content}</textarea>
					    </div>
					  </div>
					    <div class="form-group">
